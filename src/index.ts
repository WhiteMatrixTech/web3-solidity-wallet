...
const defaultAbiHelper = new AbiHelper();
...
declare class We3SolidityWalletInst {
  ...
  deploy: (
    data: We3SolidityWallet.IDeployContractActionData,
  ) => Observable<We3SolidityWallet.IEvent<We3SolidityWallet.EEventType>>;

  interact: (
    data: We3SolidityWallet.IInteractContractActionData,
  ) => Observable<We3SolidityWallet.IEvent<We3SolidityWallet.EInteractEventType>>;

  estimate?: (
    estimateData: We3SolidityWallet.IEstimateGasAndCollateralParams,
  ) => Promise<We3SolidityWallet.IEstimateGasAndCollateralResult>;

  calldata?: (
    data: We3SolidityWallet.ICalldataActionData,
  ) => Observable<We3SolidityWallet.IEvent<We3SolidityWallet.EInteractEventType>>;
...
export { defaultAbiHelper, AbiHelper, We3SolidityWalletInst };
